...
The preview starts slightly farther out for holders and returns to the closer base framing when switching back. Once you zoom the camera yourself, that distance is kept across both generators.
