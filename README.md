...
Base and holder settings share one workspace that is remembered in this browser. Each generator keeps its own active settings, while size-label visibility and magnet dimensions stay in sync between them.
